...
SELECT V.IDVEICULO,M.NOMEMARCA,V.MODELO,V.ANO,V.PLACA,V.CAMBIO,V.STATUS_VEICULO,C.TIPOCATEGORIA,MT.DSMANUTENCAO,MT.IDMANUTENCAO,C.IDCATEGORIA,M.IDMARCA from VEICULO as V
