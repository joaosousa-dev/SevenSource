...
SELECT C.NOMECLIENTE,C.EMAILCLIENTE,C.CNHCLIENTE,C.CPFCLIENTE,T.TELFIXO,T.TELMOVEL,E.RUA,E.NUMERO,E.BAIRRO,E.ESTADO,E.CIDADE,E.CEP from CLIENTE as C
inner join ENDERECO as E on E.IDENDERECO = C.IDENDERECO
inner join TELEFONE as T on T.CPFCLIENTE = C.CPFCLIENTE;
...
INSERT INTO TELEFONE (TELFIXO,TELMOVEL,CPFCLIENTE)VALUES('36964468','988557744','36936936966');
