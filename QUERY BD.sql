...
SELECT V.IDVEICULO,M.NOMEMARCA,m.idmarca,V.MODELO,V.ANO,V.PLACA,V.CAMBIO,V.STATUS_VEICULO,C.IDCATEGORIA,C.TIPOCATEGORIA,mt.idmanutencao,MT.DSMANUTENCAO from VEICULO as V
...
SELECT * FROM VWVEICULO_CATEGORIA ;
